...
- (Breaking change) Renamed deployment `host/networking/dnsmasq` to `host/networking/nm-dnsmasq-config` to reflect its updated functionality.
- (Breaking change) Renamed package `core/host/networking/dnsmasq` to `core/host/networking/nm-dnsmasq-config` to reflect its updated functionality.
